  ...
  return (
    <nav className="bg-white shadow-md">
      <div className="bg-secondary-color/40 hidden md:flex">
        <div className="container mx-auto px-4 py-2 flex justify-between items-center max-w-screen-xl text-white p-4 md:p-2">
          {/* Address - Aligned Left */}
          <div className="text-[#7F7E92] flex items-center space-x-1">
            <AddressSvg />
            <p>Address</p>
          </div>

      {/* Phone - Aligned Center */}
      <div className="text-[#7F7E92] flex items-center space-x-1 absolute left-1/2 transform -translate-x-1/2">
          <PhoneSvg/>
          <p>+94 71 211 57 79</p>
      </div>
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-6 md:flex md:items-center md:justify-between">
        ...
        <div
          className={`${
            isMobileMenuOpen ? 'flex flex-col justify-center items-center text-center w-full' : 'hidden'
          } md:hidden`}
        >
          <div className="w-full space-y-0">
            <ul className="space-y-4 font-custom2 font-medium text-[#7F7E92] pt-4 text-center max-w-full">
              <li ><button className="px-5 py-3 bg-none hover:bg-secondary-color/35 rounded w-full">HOME</button></li>
              <li><button className="px-5 py-3 bg-none hover:bg-secondary-color/35 rounded w-full">OUR STORY</button></li>
              <li><button className="px-5 py-3 bg-none hover:bg-secondary-color/35 rounded w-full">OUR TEAM</button></li>
              <li><button className="px-5 py-3 bg-none hover:bg-secondary-color/35 rounded w-full">OUR SERVICES</button></li>
            </ul>
          </div>
